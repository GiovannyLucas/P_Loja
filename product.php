				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					<?php 
						if (isset($_SESSION['user'])) {
							...
							echo '<div class="alert-danger"><center><span>Faça o <a href="" data-toggle="modal" data-target="#exampleModal">login</a> e veja os produtos!</span></center></div><br>';
...
$queryBusca = mysqli_query($conexao, $sql);
	...
	while ($dadosP = mysqli_fetch_assoc($queryBusca)) {
		...
		echo '
			<div class="col-sm-12 col-md-6 col-lg-4 p-b-50" id="resultado">
				<!-- Block2 -->
				<div class="block2">
					...
					<div class="block2-txt p-t-20">
						<a href="'.$pag.'?cat='.$dadosP['cat'].'&prod='.$dadosP['nome'].'&id='.$dadosP['cod'].'" class="block2-name dis-block s-text3 p-b-5">
							'.$dadosP['nome'].'
						</a>
