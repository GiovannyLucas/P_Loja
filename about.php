...
<body class="animsition">
		...
		<div class="container-menu-header">
			<div class="topbar">
				...
				<span class="topbar-child1">
					Envio grátis para compras a partir de $100
				</span>
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(imgs/Sobre2.jpg);">
	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		...
		<div class="t-center p-l-15 p-r-15">
			...
			<div class="t-center s-text8 p-t-20">
				Copyright © 2018. todos os direitos reservados. | GM MODAS - Formando modas com a sua cara <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">#ModasPraVc #ComVc</a>
			</div>
		</div>
	</footer>
